package dpanic.freestock.pexels.wallpaper.ui.imagelist;
...
//                    }
                    ...
                    int totalItemCount = imageListLayoutManager.getItemCount();
                    int lastItemIndex = imageListLayoutManager.findLastVisibleItemPosition();
                    if (lastItemIndex > totalItemCount - 8 && !isLoading) {
                        isLoading = true;
                        onLoadMore();
                    }
                }
