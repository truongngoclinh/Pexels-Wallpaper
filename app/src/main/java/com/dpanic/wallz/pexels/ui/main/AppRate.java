...
class AppRate implements OnClickListener, OnCancelListener {
     ...
     */
    AppRate setMinLaunchesUntilPrompt(long minLaunchesUntilPrompt) {
     ...
     * @return This {@link AppRate} object to allow chaining.
     */
    AppRate setMinDaysUntilPrompt(long minDaysUntilPrompt) {
     ...
     * @return This {@link AppRate} object to allow chaining.
     */
    AppRate setShowIfAppHasCrashed(boolean showIfCrash) {
